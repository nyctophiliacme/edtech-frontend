export const examDetailsCompleteData = [
  {
    subSection: "home",
    data: [
      {
...

      {
        ...
        type: "para",
        items: [
          "This year, UET has changed the merit calculation formula which is as follows: -",
        ],
      },

      {
        ...
        items: [
          ...
          {
            columnText: "Entry test",
            columnValue: "30%",
          },
          {
            columnText: "F.Sc Part (1)",
            columnValue: "45%",
          },
        ],
      },

      {
        ...
        items: [
          ...
          {
            columnText: "Marks in 11th Class (O level or equivalent)",
            columnValue: "70%",
          },
        ],
      },
      ...
      {
        heading: "Programs for ECAT candidates",
        listHeader: "",
        type: "list",
        items: [
    ...
    data: [
      {
        heading: "English:",
        listHeader:
          "With only 10% weightage given to this portion in the test, its preparation is relatively less stressful. </br>The English portion is further divided into ",
        type: "list",
        items: ["Vocabulary", "Grammar", "Comprehension "],
      },

      {
        ...
        type: "para",
        items: [
          "The vocabulary preparation consists of the traditional labyrinth of synonyms and antonyms even in ECAT. Key books and study materials by colleges and academies can aid the student in this regard. ",
        ],
      },
      {
        heading: "Grammar:",
        listHeader: "This part includes common topics like: ",
        type: "list",
        items: [
          "Active and passive voice",
          "Narration (direct and indirect speech)",
          "Correct and incorrect word choice or sentences",
          "Detecting errors in a sentence",
      ...
      },
      {
        ...
        type: "para",
        items: [
          "Comprehension basically refers to the understanding of an unseen passage and subsequently, answering the queries asked in the end. The questions may vary from the content to the vocabulary of the passage.",
        ],
      },

      {
        heading: "Chemistry:",
        listHeader:
          "The syllabus consists of the text given in the textbooks of the 1st and 2nd-year intermediate level. The course, as of 2019, consists of 27 whole chapters (11 from the book of Intermediate part I and 16 from Intermediate Part II). Without a doubt, preparing from both books is equally crucial in scoring well in ECAT.</br> Chapters Included</br> The important chapters included in the syllabus for ECAT are as follows:",
        type: "list",
        items: [
          ...
          " Gases ",
          " Group III-A, IV-A Elements ",
          " Group V-A, VI-A Elements ",
          " Halogens ",
          " Ketones ",
          " Liquids and solids ",
          " Macromolecules ",
...

      {
        heading: "Physics:",
        listHeader:
          "The syllabus comprises 21 Chapters in total (11 from the First Year Physics textbook and 10 from the Second Year Physics textbook).		</br> Chapters Included 		</br> Following are the important chapters included in the syllabus for Physics:",
        type: "list",
        items: [
          " Atomic spectra",
          " Alternating current",
...

      {
        heading: "Mathematics:",
        listHeader:
          "Make sure you practice this portion extensively and endlessly. Without a profound understanding of all formulae and their applications, you’re likely to fall short of the score you have decided to achieve in ECAT.</br> The syllabus of mathematics for ECAT consists of following important chapters: -",
        type: "list",
        items: [
  ...
  {
    subSection: "affiliatedInstitutes",
    data: [
      {
        heading: "ECAT affiliated Universities",
        listHeader: "",
        type: "list",
        items: [
          ...
          " Punjab University (Engineering Programs)",
          " Army Public College of management and science, Rawalpindi (UET Taxila)",
          " COMSATS Institute of Information and Technology, Islamabad (Lahore Campus)",
          " COMSATS Institute of Information and Technology, Islamabad (Wah Campus)",
          " COMSATS Institute of Information and Technology, Islamabad (Attock Campus)",
          " COMSATS Institute of Information and Technology, Islamabad (Sahiwal Campus)",
          " Fatima Jinnah Women University, Rawalpindi",
          " Government College University, Lahore",
          " Government College University, Faisalabad",
          " HITEC University, Taxila Cantt",
          " Foundation University Institute of Engineering and Management sciences, Rawalpindi",
          " College of Engineering and Emerging Technology, Lahore (University of Punjab, Lahore)",
          ...
          " Quaid e Azam College of Engineering and Technology, Sahiwal (UET Lahore)",
          " University of Wah, Wah Cantt",
          " Sharif College of Engineering and Technology, Lahore (UET Lahore)",
          ...
          " University College of Agriculture, Multan (Bahauddin Zakriya University, Multan)",
          " University College of Engineering and Technology, Multan (Bahauddin Zakriya University, Multan)",
        ],
      },
    ],
  },
  {
    subSection: "paperPattern",
    data: [
      {
        heading: "MCQ",
        type: "table",
