            ...
            return (
              <div className="subject-detail-container">
                <div
                  ...
                  style={ { background: `linear-gradient(to right,${ subject.background_start_color },${subject.background_end_color})` } }
                >
                  ss
                </div>
                <div className="subject-text-container">
                  ...
                  </span>{`for ${subject.exam_fullname}(${subject.exam_code.toUpperCase()})`}
                </div>
              </div>
            );
          })}
