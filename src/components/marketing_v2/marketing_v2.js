    ...
    return (
        <>
            ...
            <div className="illustrationsv2 marketing-container">
                <div className="illustrations-wrapper">
                    <div className="illustration-contentv2">
                        ...
                        <div className="illustration-textv2">
                            <div className="illustration-headerv2">
                                Concise &amp; <br />Convenient
                            </div>
                            <div className="illustration-bodyv2">
                                We have collected the best resources in one place, saving you time and money. Now learn
                                at your own pace.
                            </div>
                    ...
                    <div className="illustration-contentv2">
                        ...
                        <div className="illustration-textv2">
                            <div className="illustration-headerv2">Group <br />Learning</div>
                            <div className="illustration-bodyv2">
                                Make friends with smart learners. Ask questions, get answers,  share notes, come up with new ideas.
                            </div>
                        </div>
                        <div className="illustration-footer">
                    ...
                    <div className="illustration-contentv2">
                        ...
                        <div className="illustration-textv2">
                            <div className="illustration-headerv2">Expert <br />Mentors</div>
                            <div className="illustration-bodyv2">
                                Learn valuable tips and tricks from the best teachers. Direct access to smart students who aced the exams.
                            </div>
                        </div>
                        <div className="illustration-footer">
                            Take the best shot!
            ...
            <div className="video-container">
                ...
                <div>
                    <ReactPlayer url="https://www.youtube.com/watch?v=RCM8LwXaoxg" width='100%' height='650px' controls={true} loop={true} light={true} />
                </div>
            </div>
